...
import static org.lwjgl.opengl.GL11.*;
    ...
    }package cc.unknown.module.impl.render;

import cc.unknown.module.Module;
import cc.unknown.module.setting.impl.ButtonSetting;
import cc.unknown.module.setting.impl.SliderSetting;
import cc.unknown.utility.BlockUtils;
import cc.unknown.utility.CoolDown;
import cc.unknown.utility.ShaderUtils;
import cc.unknown.utility.Utils;
import net.minecraft.block.BlockBed;
import net.minecraft.block.state.IBlockState;
import net.minecraft.client.gui.Gui;
import net.minecraft.client.gui.ScaledResolution;
...
import static org.lwjgl.opengl.GL11.*;
    ...
    public class BedPlates extends Module {
        public static final ShaderUtils roundedShader = new ShaderUtils("cc/unknown:shaders/rrect.frag");
        ...
        private void drawPlate(BlockPos blockPos, int index) {
            ...
            double offset = (blocks.size() * -17.5) / 2;
            for (Block block :blocks) {
                mc.getTextureManager().bindTexture(new ResourceLocation("cc/unknown:images/" + block.getLocalizedName() + ".png"));
                Gui.drawModalRectWithCustomSizedTexture((int) offset, 10, 0, 0, 15, 15, 15, 15);
                offset += 17.5;
            }
            GlStateManager.disableBlend();
